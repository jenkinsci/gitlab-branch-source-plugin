...
[Jenkins Code as Configuration](https://github.com/jenkinsci/configuration-as-code-plugin) (JCasC),
[Incremental Tools](https://github.com/jenkinsci/incrementals-tools/).
