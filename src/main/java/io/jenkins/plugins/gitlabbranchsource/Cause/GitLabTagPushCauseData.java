...
public class GitLabTagPushCauseData {
    ...
    public GitLabTagPushCauseData(TagPushEvent tagPushEvent) {
        this.variables.put("OBJECT_KIND", defaultString(tagPushEvent.OBJECT_KIND));
        ...
        this.variables.put("HOOK_PROJECT_ID_2", defaultIntString(tagPushEvent.getProject().getId()));
        ...
        this.variables.put("HOOK_PROJECT_VISIBILITY_LEVEL", defaultVisibilityString(tagPushEvent.getProject().getVisibilityLevel()));
        ...
        this.variables.put("HOOK_REPO_VISIBILITY_LEVEL", defaultVisibilityString(tagPushEvent.getRepository().getVisibility_level()));
