...
public class GitLabServers extends GlobalConfiguration {
     ...
     *
     * @param serverUrl the {@link GitLabServer#getServerUrl()}
     * @param eventUrl  the event url.
     * @return {@code true} if the event is a matching
     * {@link GitLabServer#getAliasUrl()} for registered {@link GitLabServer} instances)
     * @since 1.0.5
     */
    ...
    public synchronized boolean removeServer(@CheckForNull String serverUrl) { // when passing predicate add an argument GitLabServerPredicate
        ...
        // TODO: Verify is this predicate works
