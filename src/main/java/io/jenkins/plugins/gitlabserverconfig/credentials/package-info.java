/**
 * GitLab specific {@link com.cloudbees.plugins.credentials.Credentials} interface and default
 * implementation. Note we use an interface so that {@link com.cloudbees.plugins.credentials.CredentialsProvider}
